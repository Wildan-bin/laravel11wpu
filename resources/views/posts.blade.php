        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            @forelse ($posts as $post)
                <article
                    ...
                    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white h-20"><a
                            href="/posts/{{ $post['slug'] }}">{{ $post['title'] }}</a></h2>
                    <p class="text-sm mb-5 font-light text-gray-500 dark:text-gray-400">
            ...
            @empty
                <div>
                    ...
                    <a href="/posts" class="block text-sm font-medium text-blue-600 hover:underline">&laquo; Back to
                        all
                        posts</a>
                </div>
            @endforelse
